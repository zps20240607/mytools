...
def build_html(tools, checks, path_info, overview):
    ...
    level_colors = {"ok": "#37c26a", "warn": "#f5a623", "error": "#ff5c5c", "info": "#5b8cff"}
...
<style>
:root { --bg:#0b0e14; --panel:#11151f; --panel2:#161c2b; --border:#1e2636;
  --text:#dbe4f0; --muted:#8b96ab; --ok:#37c26a; --warn:#f5a623; --err:#ff5c5c; --info:#5b8cff; }
* { box-sizing:border-box; }
body { margin:0; background:var(--bg); color:var(--text); font:14px/1.7 "Segoe UI","Microsoft YaHei",system-ui,sans-serif; }
.wrap { max-width:1080px; margin:0 auto; padding:24px 20px 60px; }
h1 { font-size:22px; margin:0 0 4px; } h1 small { color:var(--muted); font-size:13px; font-weight:400; }
h3 { margin:26px 0 10px; font-size:16px; border-left:3px solid var(--info); padding-left:10px; }
...
.card b { display:block; font-size:18px; } .card span { color:var(--muted); font-size:12px; }
...
li.check { background:var(--panel); border:1px solid var(--border); border-left:3px solid var(--info); border-radius:8px; padding:8px 12px; }
...
.pitem { background:var(--panel); border:1px solid var(--border); border-radius:8px; padding:10px 14px; margin-bottom:8px; }
...
<h1>EnvWatch <small>环境体检报告 · %s</small></h1>
<div class="cards">
