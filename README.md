...
| TokenWatch-Token用量统计 | 跨工具 Token 用量统计看板（Codex / Kimi Code / OpenClaw / DeepSeek Harness） | `打开Token用量看板.bat` |
...
| TodoWatch-每日清单 | 桌面驻留每日待办清单：毛玻璃、拖拽/复位、本地持久化单页 HTML | `打开每日清单.bat` |
